...
import 'package:easypass/components/past_activites_card.dart';
...
class _PastActivitiesState extends State<PastActivities>
  ...
  late List<Map<String, dynamic>> pastActivities = [];

  Future<void> callPastActivitiesData() async {
                                ...
                                delegate: SliverChildBuilderDelegate(
                                  (BuildContext context, int index) {
                                    return Padding(
                                      ...
                                      child: PastActivitiesCard(
                                        data: pastActivities[index],
                                        index: index,
                                      ),
                                    );
                                  },
                                  childCount: pastActivities.length,
                                ),
                              ),
                            ],
                          );
